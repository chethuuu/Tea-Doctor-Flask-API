...
def preprocess_mp3(sample, index):
    ...
    # Zero-padding the audio sample to a specific length (48000 in this case)
...
# Load audio file 
wav = load_mp3_16k_mono("D:\Python\python_project\tea_api\model_weights\audio_classifiyer")
